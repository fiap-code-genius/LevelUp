        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_LEVELUP_USERS_TB_LEVELUP_TEAMS_team_id",
                        column: x => x.team_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_LEVELUP_REWARD_REDEMPTIONS_TB_LEVELUP_REWARDS_reward_id",
                        column: x => x.reward_id,
                        principalTable: "TB_LEVELUP_REWARDS",
                        principalColumn: "reward_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TB_LEVELUP_REWARD_REDEMPTIONS_TB_LEVELUP_USERS_user_id",
                        column: x => x.user_id,
